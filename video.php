...
<div class='baslik'>
<label>
Video link came empty. Please go to the main page and send the link again.
</label>
</div>
</div>";
}
...
<script type='text/javascript'>
window.onblur = function(){document.title = ' We are always here. | InstaMedia.com';}
...
$video = $obj->graphql->shortcode_media->video_url;
$video_resim = $obj->graphql->shortcode_media->display_url;
...
echo '</br>';
echo"<label><img width='400px' height='300px' src='".$video_resim."'><br>";
echo "<a id='download' class='appLabel' href='".$video."' download='<".$video."'>Download the video!</a></div>";
echo "</div>";
/*?php echo $resim;?>*/
}?>